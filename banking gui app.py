...
def register():
    ...
    #Labels
    Label(register_screen, text="Please enter your details below to create an account", font=('Calibri',12)).grid(row=0,sticky=N,pady=10)
    Label(register_screen, text="Name", font=('Calibri',12)).grid(row=1,sticky=W)
    Label(register_screen, text="Phone", font=('Calibri',12)).grid(row=2,sticky=W)
    ...
    Entry(register_screen,textvariable=temp_phone).grid(row=2,column=0)
    Entry(register_screen,textvariable=temp_email).grid(row=3,column=0)
    Entry(register_screen,textvariable=temp_password,show="*").grid(row=4,column=0)

    #Buttons
    Button(register_screen, text="Create an Account", command = finish_reg, font=('Calibri',12)).grid(row=5,sticky=N,pady=10)
...
def personal_details():
    ...
    personal_details_screen.title('Account Details')
    #Labels
    Label(personal_details_screen, text="Account Details", font=('Calibri',12)).grid(row=0,sticky=N,pady=10)
    Label(personal_details_screen, text="Name : "+details_name, font=('Calibri',12)).grid(row=1,sticky=W)
    Label(personal_details_screen, text="Phone : "+details_age, font=('Calibri',12)).grid(row=2,sticky=W)
    Label(personal_details_screen, text="Email : "+details_gender, font=('Calibri',12)).grid(row=3,sticky=W)
...
#Labels
Label(master, text = "Banking Software System", font=('Calibri',14)).grid(row=0,sticky=N,pady=10)
Label(master, text = "Online Banking Application", font=('Calibri',12)).grid(row=1,sticky=N)
Label(master, image=img).grid(row=2,sticky=N,pady=15)

#Buttons
Button(master, text="Create an Account", font=('Calibri',12),width=20,command=register).grid(row=3,sticky=N)
